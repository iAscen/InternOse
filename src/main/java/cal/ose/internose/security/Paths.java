...
public class Paths {
    ...
    public static final String EMPLOYER_INTERNSHIP_OFFER_APPLICATIONS_PATH = EMPLOYER_INTERNSHIP_OFFERS_PATH
            + "/applications";
    public static final String EMPLOYER_INTERNSHIP_OFFER_APPLICATION_DETAILS_PATH = EMPLOYER_INTERNSHIP_OFFERS_PATH
    ...
    public static final String STUDENT_SEARCH_INTERNSHIP_OFFERS_LIST_PATH = STUDENT_INTERNSHIP_OFFERS_LIST_PATH
            + "/search";
    public static final String STUDENT_INTERNSHIP_OFFER_DETAILS_PATH = STUDENT_INTERNSHIP_OFFERS_LIST_PATH
            + "/{offerID}";
    ...
    public static final String INTERNSHIP_MANAGER_OFFERS_PATH = INTERNSHIP_MANAGER_BASE_PATH
            + "/employers/internship-offers";
    ...
    public static final String INTERNSHIP_MANAGER_RESUME_PATH = INTERNSHIP_MANAGER_BASE_PATH
