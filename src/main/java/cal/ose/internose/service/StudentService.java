...
public class StudentService {
    ...
    public void applyToInternship(long studentId, long internshipId) {
        Student student = studentDAO.findById(studentId)
                .orElseThrow(() -> new IllegalArgumentException("Étudiant pas trouvé"));
        InternshipOffer internshipOffer = internshipOfferDAO.findById(internshipId)
                .orElseThrow(() -> new IllegalArgumentException("Offre de stage pas trouvé"));
