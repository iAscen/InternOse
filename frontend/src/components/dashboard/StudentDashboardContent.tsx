                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-slate-700">
                            <strong
                              className="text-slate-900">{t('student.cvRequired')}</strong> {t('student.cvRequiredDesc')}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-slate-700">
                            <strong
                              className="text-slate-900">{t('student.acceptedFormat')}</strong> {t('student.acceptedFormatDesc')}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="flex-shrink-0">
                          <svg className="w-5 h-5 text-amber-500 mt-0.5" fill="none" stroke="currentColor"
                               viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                                  d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                          </svg>
                        ...
                        <div>
                          <p className="text-sm font-medium text-slate-700">
                            <strong
                              className="text-slate-900">{t('student.validation')}</strong> {t('student.validationDesc')}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="p-6">
                    {loadingContracts ? (
                      <div className="text-center p-6">
                        <div
                          className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-indigo-600"></div>
                      ...
                      const allContractsToDisplay: Array<{
                      ...
                      return (
                        <div className="space-y-4">
                          {allContractsToDisplay.map(({contract, offer}, index) => {
                            ...
                            return (
                              <div key={contract?.id || offer.id || index}
