    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
          Créer un <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">compte</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Choisissez votre type de compte pour commencer avec InternOSE
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Publiez des offres de stage et trouvez des étudiants talentueux pour votre entreprise
              </p>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Trouvez des stages passionnants et développez vos compétences professionnelles
              </p>
